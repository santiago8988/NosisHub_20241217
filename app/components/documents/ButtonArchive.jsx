...
import OffCanvasArchive from './OffCanvasArchive';

const ButtonArchive = ({documentid,currentStep}) => {
  ...
  return (
    <Fragment>
          ...
          <OffCanvasArchive open={modalShow} setOpen={setModalShow} documentid={documentid}/>
    </Fragment>
  )
}
